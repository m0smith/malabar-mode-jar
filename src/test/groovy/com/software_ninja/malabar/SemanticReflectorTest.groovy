...
class SemanticReflectorTest
{
  ...
  void setup() {
    ...
    void fieldGivesSemanticTag() throws Exception {
        ...
        assertThat(sr.asSemanticTag(f), is( ["field2", "variable", [":typemodifiers", ["public"], ":type", "java.lang.Object", 
								":declaring-class", "test.TwoFields"]]));
  ...
  void compareLists(actual, expected) {
    assertEquals( expected.size(), actual.size());
    for(int i =0; i < expected.size(); ++i){
      if( actual[i] instanceof java.util.List) {
	compareLists( actual[i], expected[i]);
      } else {
  ...
  void methodWithComplicatedGenericArgument() throws Exception {
    ...
    def expected = ["meditateAll" , function, [":typemodifiers", ["public", "abstract"], ":arguments",  [[arg0 , variable, [":type", "java.util.Collection<? extends E>"]]], ":type",  "boolean", ":declaring-class",  "test.InterfaceWithMethods"]];
    def actual = sr.asSemanticTag(m);
    
    compareLists(actual, expected);
  }
    ...
    void subClassWithInterface() throws Exception {
      def actual = sr.asSemanticTag(AbstractClass);



      def expected = ["test.AbstractClass", type, 
		     [':typemodifiers',
		      ["public", "abstract"], 
		      ':superclasses',  "test.AbstractParent<E>", 
		      ':interfaces',  ["test.SubInterface<E>"], 
		      ':template-specifier',  "<E>",  
		      ':members',  
		      [
			["AbstractClass" , function, [':constructor-flag', t, ':typemodifiers',  ["public"], ':arguments',  [], ':declaring-class',  "test.AbstractClass"]],
			["isEmpty" , function, [':typemodifiers', ["public"], ':arguments',  [], ':type',  "boolean", ':declaring-class',  "test.AbstractClass"]], 
			["iterator" , function, [':typemodifiers', ["public"], ':arguments',  [], ':type',  "java.util.Iterator<E>", ':declaring-class',  "test.AbstractParent"]],
			["clone" , function, [':typemodifiers', ["protected", "native"], ':arguments',  [], ':type',  "java.lang.Object", ':throws',  ["java.lang.CloneNotSupportedException"], ':declaring-class',  "java.lang.Object"]],
			["equals" , function, [':typemodifiers', ["public"], ':arguments',  [["arg0" , variable, [':type', "java.lang.Object"]]], ':type',  "boolean", ':declaring-class',  "java.lang.Object"]],
			["finalize" , function, [':typemodifiers', ["protected"], ':arguments',  [], ':type',  "void", ':throws',  ["java.lang.Throwable"], ':declaring-class',  "java.lang.Object"]],
			["getClass" , function, [':typemodifiers', ["public", "final", "native"], ':arguments',  [], ':type',  "java.lang.Class<?>", ':declaring-class',  "java.lang.Object"]],
			["hashCode" , function, [':typemodifiers', ["public", "native"], ':arguments',  [], ':type',  "int", ':declaring-class',  "java.lang.Object"]],
			["notify" , function, [':typemodifiers', ["public", "final", "native"], ':arguments',  [], ':type',  "void", ':declaring-class',  "java.lang.Object"]],
			["notifyAll" , function, [':typemodifiers', ["public", "final", "native"], ':arguments',  [], ':type',  "void", ':declaring-class',  "java.lang.Object"]],
			["toString" , function, [':typemodifiers', ["public"], ':arguments',  [], ':type',  "java.lang.String", ':declaring-class',  "java.lang.Object"]],
			["wait" , function, [':typemodifiers', ["public", "final"], ':arguments',  [], ':type',  "void", ':throws',  ["java.lang.InterruptedException"], ':declaring-class',  "java.lang.Object"]],
			["wait" , function, [':typemodifiers', ["public", "final", "native"], ':arguments',  [["arg0" , variable, [':type', "long"]]], ':type',  "void", ':throws',  ["java.lang.InterruptedException"], ':declaring-class',  "java.lang.Object"]],
			["wait" , function, [':typemodifiers', ["public", "final"], ':arguments',  [["arg0" , variable, [':type', "long"]], ["arg1" , variable, [':type', "int"]]], ':type',  "void", ':throws',  ["java.lang.InterruptedException"], ':declaring-class',  "java.lang.Object"]],
		      ], 
		      ':type',  "class"]];
      compareLists(actual, expected);
    }
